...
module.exports = {
  ...
  findByIdToEdit: async function (item, sessionToken) {
    try {
      const Product = Parse.Object.extend('Product');
      const query = new Parse.Query(Product);
      ...
      result.set('store', pointerToStore);
      ...
      result.set('category', pointerToCategory);
      ...
      const newProduct = await result.save(null, {sessionToken});
      return helper.toJSON(newProduct);
